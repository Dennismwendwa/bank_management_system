...
class Bank {
    ...
    public:
        ...
        void recordTransaction(const std::string& type, const SavingAccount& account, double amount,
                              const std::string& description);
        void recordTransaction(std::string transaction_id, const std::string& type, const SavingAccount& account, double amount, 
                             const std::string& description, const SavingAccount& from_account);
